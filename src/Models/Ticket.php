...
class Ticket extends AbstractModel
{
     ...
     */
    public function assignToAgent(Agent $agent, Agent|null $creator = null, $isVisible = false): self
    {
        Assignment::query()
            ->create([
                'ticket_id' => $this->id,
     ...
     * @param bool $isVisible
     */
    public function assignToTeam($team, Agent|null $creator = null, $isVisible = false): self
    {
     ...
     * @param bool $isVisible
     */
    public function dueOn($date, Agent|null $creator = null, $isVisible = true): self
    {
        DueDate::query()
            ->create([
                'ticket_id' => $this->id,
